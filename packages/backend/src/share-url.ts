 ...
 *
 * The token is the capability: 32 random bytes, base64url, 43 chars. The URL
 * is short on purpose (`/s/<token>`) because it is meant to be pasted into a
 ...
 * approval-required public-gallery gate and a human performs it.
 */
export const SHARE_STATUSES = ["unlisted", "submitted", "published", "revoked"] as const;

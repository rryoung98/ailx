...
- **50 pts — Planted errors caught (the `errorCatchRate` component).** Did the candidate catch and reject the seeded wrong outputs? Fully objective. **Eight planted errors minimum**, not four
...
| T3    | **Planted errors as traps**, revealed at the end: "you caught 6 of 8"                 | The reveal happens after submission. The traps are already the objective core of the track (§T3); naming them at the end costs nothing and produces the exam's best story.                                           |

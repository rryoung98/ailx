...
5. **Not "50 + 30 points is a measurement".** Eight planted errors give a rate with a ±0.35
   interval, and the four the 2026.1 forms actually plant give about ±0.49. The rates are
...
10. **Not "the shipped form has enough plants to report a rate".** It has four, and the floor
    the same evidence sets is eight (Schemmer, Kühl, Benz & Satzger 2022, arXiv:2204.06916:
    8 incorrect + 8 correct items per condition). Four is what the instrument deals, not what
    the evidence supports: the two tiers' T3 forms plant four, and declaring eight against
    them made the operational package refuse to open (TEN-73, TEN-91). Until the forms carry
